...
class Model_admin
{
    ...
    public function tambahDataAdmin()
    {
        $query = "INSERT INTO tb_guru
                    VALUES
                    ('',:admin_id, :nip, :password, :nik, :nama_lengkap, :tgl_lahir, :jenis_kelamin, :agama, :no_hp ,:alamat_email, :alamat, :nuptk, :bidang_studi, :jabatan, :tugas_tambahan, :status_pegawai, :status_keaktifan, :status_nikah, :tmt_pns, :tmt_cpns, :tmt_pangkat, :pangkat_golongan, :sumber_gaji, :npwp, :img, :file ,'')";
    ...
    function upload()
    {
        ...
        move_uploaded_file($tmpname, 'upload/guru/file/' . $namefile);
        return $namefile;
    ...
    function upload1()
    {
        ...
        $ekstensifilevalid = ['jpeg', 'png', 'jpg'];
        $ekstensifile = explode('.', $namefile);
        $ekstensifile = strtolower(end($ekstensifile));
        if (!in_array($ekstensifile, $ekstensifilevalid)) {
            echo "
        ...
        $namafilebaru .= '.';
        $namafilebaru .= $ekstensifile;
        move_uploaded_file($tmpname, 'upload/guru/img/' . $namefile);
        return $namefile;
