                            ...
                            <div class="x_content">
                                <div class="col-md-3 col-sm-3  profile_left">
                                    <div class="profile_img">
                                        <div id="crop-avatar">
                                            <!-- Current avatar -->
                                            <img width="100%" class="img-responsive avatar-view" src="<?= BASE_URL; ?>/upload/pegawai/img/<?= $data['admin']['img']; ?>" alt="<?= $data['admin']['img']; ?>" title="Change the avatar">
                                        </div>
                                    </div>
                                    ...
                                    <a href="<?= BASE_URL; ?>/Pegawai" class="btn btn-secondary" style="color: white;"><i class="fa fa-angle-double-left"></i> Kembali</a>
                                    <br>
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            ...
                                            <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Data Kegiatan</a>
                                            </li>
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane active " id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <ul class="messages">
                                                    <li>
                                                        <img src="<?= BASE_URL; ?>/upload/pegawai/img/<?= $data['admin']['img']; ?>" class="avatar" alt="Avatar">
                                                            ...
                                                            <blockquote class="message">
                                                                <div class="container" style="font-size:17px; color:#06113C;">
                                                                    <div class="row">
                                                                        ...
                                                                        <br>
                                                                        <div class="col-6">
                                                                            Tambhan Tugas : <?= $data['admin']['tugas_tambahan']; ?>
                                                                        </div>
                                                                        <div class="col-6">
                                                                        ...
                                                                        <div class="col-6">
                                                                            File : <?= $data['admin']['file']; ?> <a class="btn btn-info btn-sm" style="color:white;" href="<?= BASE_URL; ?>/upload/pegawai/file/<?= $data['admin']['file']; ?>"><i class="fa fa-save"></i></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </blockquote>
