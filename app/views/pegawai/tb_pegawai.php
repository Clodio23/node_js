                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            <?php Flashh::flash(); ?>
                                            <span><button type="button" class="btn btn-primary tambahPegawai" data-bs-toggle="modal" data-bs-target="#formtambah">
                                                ...
                                                <tbody style="text-align: center;">
                                                    ...
                                                    <?php foreach ($data['admin'] as $admin) : ?>
                                                        <tr>
                                                            <td><?= $no++; ?></td>
                                                            <td><?= $admin['nip']; ?></td>
                                                            <td><img src="<?= BASE_URL; ?>/upload/pegawai/img/<?= $admin['img']; ?>" alt="" width="100"></td>
                                                            ...
                                                            <td>
                                                                <div class="btn-group btn-group-sm" role="group">
                                                                    ...
                                                                    <a href="<?= BASE_URL; ?>/Pegawai/detail/<?= $admin['id']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>

                                                                    <a href="<?= BASE_URL; ?>/Pegawai/ubah/<?= $admin['id']; ?>" class="btn btn-success tampilEditDataPegawai" data-bs-toggle="modal" data-bs-target="#formtambah" data-id="<?= $admin['id']; ?>"><i class=" fa fa-pencil-square-o"></i></a>

                                                                    <a class="btn btn-secondary" onclick="return confirm('Anda Yakin Ingin Menghapus Data');" href="<?= BASE_URL; ?>/Pegawai/hapusPegawai/<?= $admin['id']; ?>"><i class="fa fa-trash"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
