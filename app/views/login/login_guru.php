            ...
            <div class="animate form login_form">
                <section class="login_content">
                    ...
                    <form id="login-form" class="form" action="" method="post">
                        <h1 style="color: white;">LOGIN GURU</h1>
                        ...
                        <div class="separator" style="color: white ;">
                            <p class="change_link"> Login Sebagai
                                <br>
                                &nbsp;&nbsp;&nbsp;
                                <a class="btn btn-danger btn-sm" href="<?= BASE_URL; ?>/login/index"> Admin </a>

                                <a class="btn btn-danger btn-sm" href="<?= BASE_URL; ?>/login/login_pegawai"> Pegawai </a>
                            </p>
                            <p class="change_link"> Buat Akun Baru ?
                                <a href="<?= BASE_URL; ?>/register/guru" class="#" style="color:aqua ;"> Regisrasi </a>
                            </p>
                            <div class="clearfix"></div>
                            <br />
