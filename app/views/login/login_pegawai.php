            ...
            <div class="animate form login_form">
                <section class="login_content">
                    ...
                    <form id="login-form" class="form" action="" method="post">
                        <h1 style="color: white;">LOGIN PEGAWAI</h1>
                        ...
                        <div class="separator" style="color: white ;">
                            <p class="change_link"> Login Sebagai
                                ...
                                <a class="btn btn-danger btn-sm" href="<?= BASE_URL; ?>/login/login_guru"> Guru </a>
                            </p>
                            <p class="change_link"> Buat Akun Baru ?
                                <a href="<?= BASE_URL; ?>/register/pegawai" class="#" style="color:aqua ;"> Regisrasi </a>
                            </p>
                            <div class="clearfix"></div>
                            <br />
