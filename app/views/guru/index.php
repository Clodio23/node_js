            ...
            <div class="right_col" role="main">
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Tabel Kumpulan Data Guru : <small><?= $data['nama']; ?></small></h2>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            <?php Flashh::flash(); ?>
                                            <span><button type="button" class="btn btn-primary tombolTambahGuru" data-bs-toggle="modal" data-bs-target="#formtambah">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group btn-group-sm" role="group">
                                                                    <a href="<?= BASE_URL; ?>/Guru/detail/<?= $admin['id']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>

                                                                    <a href="<?= BASE_URL; ?>/Guru/ubah/<?= $admin['id']; ?>" class="btn btn-primary tombolUbahGuru" data-bs-toggle="modal" data-bs-target="#formtambah" data-id="<?= $admin['id']; ?>"><i class="fa fa-pencil-square-o"></i></a>

                                                                    <a class="btn btn-secondary" onclick="return confirm('Anda Yakin Ingin Menghapus Data');" href="<?= BASE_URL; ?>/Guru/hapusGuru/<?= $admin['id']; ?>"><i class="fa fa-trash"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="x_content">
                                    <h5 class="" id="formModalLabel" style="text-align: center;">Form Tambah Data Guru</h5>
                                    <br>
                                    <form method="POST" action="<?= BASE_URL; ?>/Guru/tambahGuru" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        <div class="container">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="hidden" name="tgl_inputdata" id="tgl_inputdata">
                                                    <!-- <div class="item form-group">
                                                        <label class="col-form-label  col-sm-3 label-align" for="tgl_inputdata">TTL.data <span class="required">:</span>
                                                        </label>
                                                        <div class="col-md-5">
                                                            <input type="text" id="tgl_inputdata" name="tgl_inputdata" required="required" class="form-control">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="date" id="tgl_inputdata" name="tgl_inputdata" required="required" class="form-control">
                                                        </div>
                                                    </div> -->
                                                </div>
