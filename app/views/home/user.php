                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <button type="button" class="btn btn-warning tambah" style="color: white;" data-bs-toggle="modal" data-bs-target="#formtambah" data-id="<?php echo '$admin->id'; ?>"">
                                    <i class=" fa fa-pencil"></i>Isi Data
                                </button>
                            ...
                            <div class="x_content">
                                <div class="col-md-3 col-sm-3  profile_left">
                                    <div class="profile_img">
                                        <div id="crop-avatar">
                                            ...
                                            <?php foreach ($data['admin'] as $admin) : ?>
                                                <img width="100%" class="img-responsive avatar-view" src="<?= BASE_URL; ?>/upload/guru/img/<?php echo "$admin->img"; ?>" alt="<?php echo "$admin->img"; ?>" title="Change the avatar">
                                        </div>
                                    </div>
                                    ...
                                    <span><button type="button" class="btn btn-primary tombolUbahGuru" data-bs-toggle="modal" data-bs-target="#formtambah" data-id="<?php echo "$admin->id"; ?>">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane active " id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <ul class="messages">
                                                    <li>
                                                        <img src="<?= BASE_URL; ?>/upload/guru/img/<?php echo "$admin->img"; ?>" class="avatar" alt="<?php echo "$admin->img"; ?>">
                                                            ...
                                                            <blockquote class="message">
                                                                <div class="container" style="font-size:17px; color:#06113C;">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-6">
                                                                            File : <?php echo "$admin->file"; ?> <a class="btn btn-info btn-sm" style="color:white;" href="<?= BASE_URL; ?>/upload/guru/file/<?php echo "$admin->file"; ?>"><i class="fa fa-save"></i></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </blockquote>
                                                ...
                                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo "$admin->absen"; ?></td>
                                                            <td><?php echo "$admin->keterangan"; ?></td>
                                                            <td><?php echo "$admin->file"; ?></td>
